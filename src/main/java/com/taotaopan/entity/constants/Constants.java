package com.taotaopan.entity.constants;
...
public class Constants {
    ...
    public static final String REDIS_KEY_DOWNLOAD = "taotaopan:download:";

    public static final String REDIS_KEY_SYS_SETTING = "taotaopan:syssetting:";

    public static final String REDIS_KEY_USER_SPACE_USE = "taotaopan:user:spaceuse:";

    public static final String REDIS_KEY_USER_FILE_TEMP_SIZE = "taotaopan:user:file:temp:";
